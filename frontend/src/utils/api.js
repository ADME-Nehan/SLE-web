...
// Social Posts
export const generateSocialPostPreview = (data) =>
  api.post("/social-posts/preview", data);

export const saveSocialPost = (data) => api.post("/social-posts", data);

export const getSocialPosts = () => api.get("/social-posts");

export const removeSocialPost = (id) => api.delete(`/social-posts/${id}`);
